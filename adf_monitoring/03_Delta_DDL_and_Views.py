...
# MAGIC     stale_threshold_min   INT        NOT NULL DEFAULT 30 COMMENT 'Minutes without update before flagging as stuck',
...
# MAGIC     _updated_ts           TIMESTAMP  NOT NULL DEFAULT current_timestamp() COMMENT 'Last update time'
# MAGIC )
# MAGIC USING DELTA
