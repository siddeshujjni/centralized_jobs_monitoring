...
# MAGIC -- SELECT 
# MAGIC --     COUNT(*) AS failure_count,
# MAGIC --     ARRAY_DISTINCT(COLLECT_LIST(CONCAT(pipeline_name, '.', activity_name))) AS failed_activities
...
# MAGIC --     ROUND(PERCENTILE_APPROX(duration_ms, 0.5) / 60000.0, 1) AS p50_min,
# MAGIC --     ROUND(PERCENTILE_APPROX(duration_ms, 0.95) / 60000.0, 1) AS p95_min,
# MAGIC --     ROUND(PERCENTILE_APPROX(duration_ms, 0.99) / 60000.0, 1) AS p99_min
# MAGIC -- FROM <CATALOG>.<SCHEMA>.adf_pipeline_runs
